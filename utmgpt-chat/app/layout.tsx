...
const Logo = () => (
  <div className="h-8 flex-shrink-0 self-start flex items-center">
    <span className="text-2xl font-bold">UTMGPT</span>
  </div>
);
  ...
  return (
    <html lang="en">
      ...
      <body className={publicSans.className}>
        <NuqsAdapter>
          <div className="bg-secondary w-full flex flex-col h-[100dvh]">
